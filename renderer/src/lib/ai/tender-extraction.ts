...
import { validateTenderExtractionWithZod, sanitizeTenderExtraction, TenderExtraction } from './tender-validation';
 ...
 */
export function parseTenderExtractionResult(extractedText: string): TenderExtraction {
 ...
 */
function extractPartialData(text: string): TenderExtraction | null {
  try {
    const result: TenderExtraction = {
      reference: '',
      title: '',
      organization: '',
      closingDate: '',
 ...
 */
export function validateTenderExtraction(data: TenderExtraction): string[] {
  const errors: string[] = [];
 ...
 */
export function needsHumanReview(data: TenderExtraction): boolean {
