...
export default function DesktopDashboard() {
  ...
  const handleProcessDocuments = () => {
    if (typeof window !== 'undefined' && window.electronAPI) {
      ...
      toast.success('Processing all pending documents...');
    } else {
      router.push('/documents/ai');
    }
  };

  const handleImportDocuments = () => {
    if (typeof window !== 'undefined' && window.electronAPI) {
      window.electronAPI.send('import-documents', {});
      toast.info('Opening file selector...');
    } else {
      router.push('/documents?action=import');
    }
  };

  const handleReviewExtractions = () => {
    if (typeof window !== 'undefined' && window.electronAPI) {
      router.push('/tenders?filter=pending-review');
    } else {
      router.push('/tenders?filter=pending-review');
    }
  };
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: CheckCircle,
      action: handleReviewExtractions
    },
    {
      id: 4,
      title: "View Reports",
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleProcessDocuments}>
