          ...
          <div className="bg-white rounded-xl shadow-sm border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-green-600">{stats?.active || products.filter(p => p.isActive).length}</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-600">{stats?.inactive || products.filter(p => !p.isActive).length}</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border p-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-purple-600">{stats?.categories || categories.length}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-right text-sm font-medium text-gray-600">Unit Price</th>
                    <th className="px-6 py-4 text-right text-sm font-medium text-gray-600">Cost Price</th>
                    <th className="px-6 py-4 text-center text-sm font-medium text-gray-600">Min Stock</th>
                  ...
                  {products.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-right text-gray-600">
                        {product.costPrice ? formatCurrency(product.costPrice, product.currency) : '-'}
                      </td>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" className="w-full px-3 py-2 border rounded-lg" placeholder="Enter product name" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">SKU *</label>
                  <input type="text" className="w-full px-3 py-2 border rounded-lg" placeholder="PRD-001" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" className="w-full px-3 py-2 border rounded-lg" placeholder="Manufacturer name" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea className="w-full px-3 py-2 border rounded-lg" rows={3} placeholder="Product description..." />
              </div>
            </div>
