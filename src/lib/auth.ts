...
function getNextAuthSecret(): string {
  ...
  if (!secret) {
    console.warn(
      '⚠️ NEXTAUTH_SECRET not set - using development fallback. Set this in production!'
    );
  }
...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ADMIN: ['*'],
  CEO: ['budgets:*', 'tenders:*', 'reports:*', 'users:view', 'expenses:*', 'invoices:*'],
  CFO: ['budgets:*', 'expenses:*', 'reports:*', 'invoices:*', 'tenders:view'],
  FINANCE_MANAGER: ['budgets:view', 'budgets:approve', 'expenses:*', 'invoices:*', 'reports:view'],
  MANAGER: [
    'budgets:view',
    'budgets:create',
    'expenses:create',
  ...
  SALES: ['tenders:*', 'customers:*', 'invoices:view', 'budgets:view'],
  WAREHOUSE: ['inventory:*', 'products:view', 'tenders:view'],
  FINANCE: ['invoices:*', 'expenses:*', 'reports:view', 'budgets:view'],
};
