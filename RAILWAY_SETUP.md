...
# Replace with your actual Railway URL (e.g., https://dashboard2-production.up.railway.app)
NEXTAUTH_URL=https://your-app.railway.app

# DATABASE_URL is auto-populated by Railway when you add PostgreSQL service
# If not, manually add: ${{Postgres.DATABASE_URL}}
```
